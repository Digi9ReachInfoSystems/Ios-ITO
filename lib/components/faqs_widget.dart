          ...
          children: [
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('FAQS_COMP_Container_ytbxk1st_ON_TAP');
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'm57ahbp9' /* How do I register for summer q... */,
                              ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'b56h4vir' /* Students registered at ITO can... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'hhbr588x' /* What is the procedure to enrol... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'ibydo1sw' /* Students can login in the stud... */,
                            ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'whg2fpm4' /* The Summer Quiz comprises of 5... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
