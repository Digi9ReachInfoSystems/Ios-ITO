...
import 'cartvalue_copy_copy_model.dart';
export 'cartvalue_copy_copy_model.dart';

class CartvalueCopyCopyWidget extends StatefulWidget {
  const CartvalueCopyCopyWidget({super.key});

  static String routeName = 'CartvalueCopyCopy';
  static String routePath = '/cartvalueCopyCopy';

  @override
  State<CartvalueCopyCopyWidget> createState() =>
      _CartvalueCopyCopyWidgetState();
}

class _CartvalueCopyCopyWidgetState extends State<CartvalueCopyCopyWidget> {
  late CartvalueCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartvalueCopyCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CartvalueCopyCopy'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CARTVALUE_COPY_COPY_CartvalueCopyCopy_ON');
      logFirebaseEvent('CartvalueCopyCopy_update_app_state');
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CARTVALUE_COPY_COPY_arrow_back_rounded_I');
          ...
          title: InkWell(
            ...
            onTap: () async {
              logFirebaseEvent('CARTVALUE_COPY_COPY_Text_3075q06e_ON_TAP');
                ...
                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'CARTVALUE_COPY_COPY_delete_sharp_ICN_ON_');
                                          logFirebaseEvent(
                  ...
                  if (!(FFAppState().applied.isNotEmpty))
                    InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'CARTVALUE_COPY_COPY_Container_cy7vx6p8_O');
                        logFirebaseEvent('Container_navigate_to');

                        context.pushNamed(CouponsWidget.routeName);
                      },
                      child: Material(
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CARTVALUE_COPY_COPY_Text_ukbbbk8u_ON_TAP');
                                        logFirebaseEvent(
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'yw4e34bv' /* Note : Delivery Charges Will B... */,
                          ),
                          style:
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'v8f1e20m' /* I agree to Terms & Condition */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CARTVALUE_COPY_COPY_Text_qk9mqxuf_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: (FFAppState().combofinalamount == 0.0)
                              ...
                              : () async {
                                  logFirebaseEvent(
                                      'CARTVALUE_COPY_COPY_PAY_NOW_BTN_ON_TAP');
                                  if (_model.checkboxValue == true) {
                                    ...
                                    if ((_model.apiResult3ma?.succeeded ??
                                      ...
                                      if ((_model.payApi?.succeeded ?? true)) {
                                        ...
                                        context.pushNamed(
                                            CartvalueCopyCopyWidget.routeName);
                                      }
                                    }
                                  } else {
                                    logFirebaseEvent('Button_alert_dialog');
