...
import 'monthlyexam_copy_model.dart';
export 'monthlyexam_copy_model.dart';

class MonthlyexamCopyWidget extends StatefulWidget {
  const MonthlyexamCopyWidget({
    super.key,
    this.serviceid,
  ...
  static String routeName = 'monthlyexamCopy';
  static String routePath = '/monthlyexamCopy';

  @override
  State<MonthlyexamCopyWidget> createState() => _MonthlyexamCopyWidgetState();
}

class _MonthlyexamCopyWidgetState extends State<MonthlyexamCopyWidget> {
  late MonthlyexamCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MonthlyexamCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'monthlyexamCopy'});
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('MONTHLYEXAM_COPY_arrow_back_rounded_ICN_');
                            ...
                            return GridView.builder(
                              ...
                              itemBuilder: (context, childrenIndex) {
                                ...
                                return InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'MONTHLYEXAM_COPY_Container_91plww0g_ON_T');
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'MONTHLYEXAM_COPY_PAGE_BUY_NOW_BTN_ON_TAP');
                        if (widget.choosenservice ==
