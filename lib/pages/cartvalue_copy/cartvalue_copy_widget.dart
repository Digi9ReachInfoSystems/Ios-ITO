                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          allproductsItem.noOfitems.toString(),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.readexPro(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'CARTVALUE_COPY_delete_sharp_ICN_ON_TAP');
                                          logFirebaseEvent(
                                              'IconButton_update_app_state');
                                          FFAppState()
                                              .removeAtIndexFromTotalcombocart(
                                                  allproductsIndex);
                                          ...
                                          FFAppState().combodedliveryfee =
                                              valueOrDefault<double>(
                                            functions.deliveryfee(FFAppState()
                                                .totalcombocart
                                                .toList()),
                                            0.0,
                                          );
